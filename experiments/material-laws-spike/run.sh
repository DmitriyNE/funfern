...
spike_tmp="$(mktemp -d /tmp/funfern-material-spike.XXXXXX)"
...
OPENBLAS_NUM_THREADS=1 VECLIB_MAXIMUM_THREADS=1 python3 "$spike_dir/spike.py" "$spike_tmp/fixtures.json"
